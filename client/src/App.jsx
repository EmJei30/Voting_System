...
function App() {
	const assignedURL = 'https://erp-voting.mysql.database.azure.com';
	...
	return (
		<div className='App'>
			<BrowserRouter>
				<VotingContext.Provider value={{ assignedURL, isLoggedIn, setisLoggedIn,usersName, setUsersName, voteRecords, setVoteRecords,VoteTransactions, setVoteTransactions,
												membersInfo, setMembersInfo, candidates, setCandidates,usersID, setUsersID,countDown, setCountDown, otpCode, setOtpCode,
												groupedCandidates, setGroupedCandidates, maxCandidatesPerPositionState, setMaxCandidatesPerPositionState,highestVoteCount, setHighestVoteCount  }}>
					<div className='pages'>
						<Routes>
							{/* <Route path='/' element={ isLoggedIn ? (<Navigate to='/home' /> ) : (<Navigate to='/login'/>)}/> */}
							<Route path='/' element={isLoggedIn ? (<Navigate to='/dashboard' />) : (<Navigate to='/log-in' />)} />
							<Route path='/' element={isLoggedIn ? (<Navigate to='/voting-system' />) : (<Navigate to='/log-in' />)} />
							<Route path='/' element={isLoggedIn ? (<Navigate to='/verification' />) : (<Navigate to='/log-in' />)} />
							<Route path='/' element={isLoggedIn ? (<Navigate to='/administrator' />) : (<Navigate to='/log-in' />)} />
							<Route path='/' element={isLoggedIn ? (<Navigate to='/voting-dashboard' />) : (<Navigate to='/log-in' />)} />
							<Route path='/' element={isLoggedIn ? (<Navigate to='/winning-dashboard' />) : (<Navigate to='/log-in' />)} />
							...
							{isLoggedIn && (
								<>
									...
									<Route path='/winning-dashboard' element={<WinningCandidates />} />
